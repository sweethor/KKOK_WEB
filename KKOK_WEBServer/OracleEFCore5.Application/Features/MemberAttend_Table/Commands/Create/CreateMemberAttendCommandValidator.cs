...
{
    public class CreateMemberAttendCommandValidator : AbstractValidator<CreateMemberAttendCommand>
    {
        private readonly IMemberAttendRepositoryAsync memberattendRepository;

        public CreateMemberAttendCommandValidator(IMemberAttendRepositoryAsync memberattendRepository)
        {
            this.memberattendRepository = memberattendRepository;
        ...
        {
            return await memberattendRepository.IsUniqueMemberAttendCodeAsync(code);
        }
    }
}
