...
{
    public class CreateProjectPlanCommandValidator : AbstractValidator<CreateProjectPlanCommand>
    {
        private readonly IProjectPlanRepositoryAsync projectplanRepository;

        public CreateProjectPlanCommandValidator(IProjectPlanRepositoryAsync projectplanRepository)
        {
        ...
        {
            return await projectplanRepository.IsUniqueProjectPlanCodeAsync(code);
        }
    }
}
