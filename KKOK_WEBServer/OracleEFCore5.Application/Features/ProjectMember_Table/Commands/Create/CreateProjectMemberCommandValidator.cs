...
namespace OracleEFCore5.Application.Features.DbTestTable.Commands.Create
{
    ...
    {
        private readonly IProjectMemberRepositoryAsync projectmemberRepository;

        public CreateProjectMemberCommandValidator(IProjectMemberRepositoryAsync projectmemberRepository)
        {
        ...
        {
            return await projectmemberRepository.IsUniqueProjectMemberCodeAsync(code);
        }
    }
}
