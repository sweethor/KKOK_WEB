...
{
    public class CreateProjectNoticeCommandValidator : AbstractValidator<CreateProjectNoticeCommand>
    {
        private readonly IProjectNoticeRepositoryAsync projectnoticeRepository;

        public CreateProjectNoticeCommandValidator(IProjectNoticeRepositoryAsync projectnoticeRepository)
        {
        ...
        {
            return await projectnoticeRepository.IsUniqueProjectNoticeCodeAsync(code);
        }
    }
}
