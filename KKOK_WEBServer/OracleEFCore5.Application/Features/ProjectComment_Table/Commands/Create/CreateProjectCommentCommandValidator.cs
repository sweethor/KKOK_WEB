...
namespace OracleEFCore5.Application.Features.DbTestTable.Commands.Create
{
    ...
    {
        private readonly IProjectCommentRepositoryAsync projectcommentRepository;

        public CreateProjectCommentCommandValidator(IProjectCommentRepositoryAsync projectcommentRepository)
        {
        ...
        {
            return await projectcommentRepository.IsUniqueProjectCommentCodeAsync(code);
        }
    }
}
